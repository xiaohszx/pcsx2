...
// Nothing it actually says below is actually being done. It's a rewrite that never happened.
// However, some things are hooked to this (largely memory cards), so it can't be completely
...
// removed PS2E_LIB_THISPTR - (library scope version of PS2E_THISPTR)
...
// Deleted the new unused GS api here.
...
// Deleted the new unused PAD interface here.
